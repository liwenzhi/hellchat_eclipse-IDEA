...
public class BubbleChartRenderer extends AbstractChartRenderer {
    ...
    /**
     * True if bubbleScale = bubbleScaleX so the renderer should used {@link lecho.lib.hellocharts.computator.ChartComputator#computeRawDistanceX(float)}
     * , if false bubbleScale = bubbleScaleY and renderer should use
     * {@link lecho.lib.hellocharts.computator.ChartComputator#computeRawDistanceY(float)}.
     */
