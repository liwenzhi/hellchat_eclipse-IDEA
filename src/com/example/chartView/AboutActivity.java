...
public class AboutActivity extends FragmentActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            TextView go_to_wenzhi_github = (TextView) rootView.findViewById(R.id.go_to_wenzhi_github);
            go_to_wenzhi_github.setOnClickListener(new View.OnClickListener() {
            ...
            TextView go_to_wenzhi_CSDN = (TextView) rootView.findViewById(R.id.go_to_wenzhi_CSDN);
            go_to_wenzhi_CSDN.setOnClickListener(new View.OnClickListener() {
